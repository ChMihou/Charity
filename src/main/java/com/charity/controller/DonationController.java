...
public class DonationController {
    ...
    public Integer editdonation(String donations,String dusername,Integer dsid,Integer did,String daddress,Integer dmoney,Integer score,HttpServletRequest request)
    {
        ...
        donation.setDaddress(daddress);donation.setDmoney(dmoney);donation.setDonations(donations);
        donation.setDuid(uid);donation.setDid(did);
        Score score1 = new Score();
        score1.setScause(Scause);
        score1.setScore(score);score1.setSid(dsid);
    ...
    public Integer adddonation(String donations,String dusername,String daddress,Integer score,Integer dmoney,HttpServletRequest request)
    {
        ...
        score1.setScause(Scause);score1.setScore(score);score1.setSuid(uid);score1.setStime(stime);
        Integer f = scoreService.updatescore(score1);
        Integer sid = score1.getSid();
        Donation donation = new Donation();
        donation.setDaddress(daddress);donation.setDmoney(dmoney);donation.setDsid(sid);donation.setDonations(donations);
        donation.setDuid(23);
        System.out.println(donation);
